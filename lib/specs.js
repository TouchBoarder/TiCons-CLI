...
exports['ios-appicon'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon.png'),
  size: 57,
...
exports['ios-appicon@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon@2x.png'),
  size: 114,
  platforms: ['iphone'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-60.png'),
  size: 60,
  platforms: ['iphone'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-72'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-72.png'),
  size: 72,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-72@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-72@2x.png'),
  size: 144,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-40'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-Small-40.png'),
  size: 40,
  platforms: ['ios'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-40@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-Small-40@2x.png'),
  size: 80,
  platforms: ['ios'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-50'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-Small-50.png'),
  size: 50,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-50@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-Small-50@2x.png'),
  size: 100,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-83.5@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iphone', 'Icon-83.5@2x.png'),
  size: 167,
  platforms: ['ipad'],
  minVersion: 9,
  sdkVersion: '<5.0.0'
