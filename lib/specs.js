...
exports['ios-iTunesArtwork'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'iTunesArtwork.png'),
  size: 512,
  platforms: ['ios'],
  sdkVersion: '<5.0.0'
};
exports['ios-iTunesArtwork@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'iTunesArtwork@2x.png'),
  size: 1024,
  platforms: ['ios'],
  sdkVersion: '<5.0.0'
};
...
exports['ios-appicon'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon.png'),
  size: 57,
...
exports['ios-appicon@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon@2x.png'),
  size: 114,
  platforms: ['iphone'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-60.png'),
  size: 60,
  platforms: ['ipro'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-60@2x.png'),
  size: 120,
  platforms: ['iphone'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-60@3x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-60@3x.png'),
  size: 180,
  platforms: ['ipro'],
  minVersion: 8,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-72'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-72.png'),
  size: 72,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-72@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-72@2x.png'),
  size: 144,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-76'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-76.png'),
  size: 76,
  platforms: ['ipad'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-76@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-76@2x.png'),
  size: 152,
  platforms: ['ipad'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small.png'),
  size: 29,
  platforms: ['iphone', 'ios'],
  sdkVersion: '<5.0.0'
};
exports['ios-appicon-Small@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small@2x.png'),
  size: 58,
  platforms: ['iphone', 'ios'],
  sdkVersion: '<5.0.0'
};
exports['ios-appicon-Small@3x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small@3x.png'),
  size: 87,
  platforms: ['ipro'],
  minVersion: 8,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-40'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small-40.png'),
  size: 40,
  platforms: ['ios'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-40@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small-40@2x.png'),
  size: 80,
  platforms: ['ios'],
  minVersion: 7,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-50'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small-50.png'),
  size: 50,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-Small-50@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-Small-50@2x.png'),
  size: 100,
  platforms: ['ipad'],
  maxVersion: 6,
  sdkVersion: '<5.0.0'
...
exports['ios-appicon-83.5@2x'] = {
  type: 'icon',
  path: path.join(':assets:', 'iOS', 'Resources', 'Icon-83.5@2x.png'),
  size: 167,
  platforms: ['ipro'],
  minVersion: 9,
  sdkVersion: '<5.0.0'
...
exports['ios-Default'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default.png'),
...
exports['ios-Default@2x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default@2x.png'),
...
exports['ios-Default-568h@2x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-568h@2x.png'),
...
exports['ios-Default-667h@2x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-667h@2x.png'),
...
exports['ios-Default-Portrait-736h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-Portrait-736h@3x.png'),
...
exports['ios-Default-Landscape-736h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-Landscape-736h@3x.png'),
...
exports['ios-Default-Portrait'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-Portrait.png'),
...
exports['ios-Default-Portrait@2x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-Portrait@2x.png'),
...
exports['ios-Default-Landscape'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-Landscape.png'),
...
exports['ios-Default-Landscape@2x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'Default-Landscape@2x.png'),
...
exports['LaunchLogo~iphone'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'LaunchLogo~iphone.png'),
  size: 320,
  platforms: ['iphone'],
  sdkVersion: '>=5.2.0',
  alpha: true,
...
exports['LaunchLogo@2x~iphone'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'LaunchLogo@2x~iphone.png'),
  size: 374,
  platforms: ['iphone'],
  sdkVersion: '>=5.2.0',
  alpha: true,
...
exports['LaunchLogo@3x~iphone'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'LaunchLogo@3x~iphone.png'),
  size: 621,
  platforms: ['iphone'],
  sdkVersion: '>=5.2.0',
  alpha: true,
...
exports['LaunchLogo~ipad'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'LaunchLogo~ipad.png'),
  size: 384,
  platforms: ['ipad'],
  sdkVersion: '>=5.2.0',
  alpha: true,
...
exports['LaunchLogo@2x~ipad'] = {
  type: 'splash',
  path: path.join(':assets:', 'iOS', 'Resources', 'LaunchLogo@2x~ipad.png'),
  size: 1024,
  platforms: ['ipad'],
  sdkVersion: '>=5.2.0',
  alpha: true,
...
exports['ios-images@3x'] = {
  type: 'asset',
  path: path.join(':assets:', 'iOS', 'Resources', 'images'),
...
exports['android-appicon-ldpi'] = {
  type: 'icon',
  path: path.join(':assets:', 'Android', 'Resources', 'drawable-ldpi', 'appicon.png'),
  size: 36,
  alpha: true,
...
exports['android-appicon-mdpi'] = {
  type: 'icon',
  path: path.join(':assets:', 'Android', 'Resources', 'drawable-mdpi', 'appicon.png'),
  size: 48,
  alpha: true,
  dpi: constants.dpi.mdpi,
  platforms: ['android']
...
exports['android-appicon-hdpi'] = {
  type: 'icon',
  path: path.join(':assets:', 'Android', 'Resources', 'drawable-hdpi', 'appicon.png'),
  size: 72,
  alpha: true,
...
exports['android-appicon-xhdpi'] = {
  type: 'icon',
  path: path.join(':assets:', 'Android', 'Resources', 'drawable-xhdpi', 'appicon.png'),
  size: 96,
  alpha: true,
  dpi: constants.dpi.xhdpi,
  platforms: ['android']
...
exports['android-appicon-xxhdpi'] = {
  type: 'icon',
  path: path.join(':assets:', 'Android', 'Resources', 'drawable-xxhdpi', 'appicon.png'),
  size: 144,
  alpha: true,
  dpi: constants.dpi.xxhdpi,
  platforms: ['android']
...
exports['android-appicon-xxxhdpi'] = {
  type: 'icon',
  path: path.join(':assets:', 'Android', 'Resources', 'drawable-xxxhdpi', 'appicon.png'),
  size: 192,
  alpha: true,
...
exports['android-default-notlong-port-xxxhdpi'] = {
  ...
  ninePath: path.join(':assets:', 'Android', 'Resources', 'drawable-xxxhdpi', 'background.9.png'),
  nineLocalePath: path.join(':assets:', 'Android', 'Resources', 'drawable-:locale:-xxxhdpi', 'background.9.png'),
  width: 1280,
  height: 1920,
  dpi: constants.dpi.xxxhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-xxhdpi'] = {
  ...
  ninePath: path.join(':assets:', 'Android', 'Resources', 'drawable-xxhdpi', 'background.9.png'),
  nineLocalePath: path.join(':assets:', 'Android', 'Resources', 'drawable-:locale:-xxhdpi', 'background.9.png'),
  width: 960,
  height: 1600,
  dpi: constants.dpi.xxhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-xhdpi'] = {
  ...
  ninePath: path.join(':assets:', 'Android', 'Resources', 'drawable-xhdpi', 'background.9.png'),
  nineLocalePath: path.join(':assets:', 'Android', 'Resources', 'drawable-:locale:-xhdpi', 'background.9.png'),
  width: 640,
  height: 960,
  dpi: constants.dpi.xhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-hdpi'] = {
  ...
  ninePath: path.join(':assets:', 'Android', 'Resources', 'drawable-hdpi', 'background.9.png'),
  nineLocalePath: path.join(':assets:', 'Android', 'Resources', 'drawable-:locale:-hdpi', 'background.9.png'),
  width: 480,
  height: 800,
  heightFix: 640,
  dpi: constants.dpi.hdpi,
...
exports['android-default-notlong-port-mdpi'] = {
  ...
  ninePath: path.join(':assets:', 'Android', 'Resources', 'drawable-mdpi', 'background.9.png'),
  nineLocalePath: path.join(':assets:', 'Android', 'Resources', 'drawable-:locale:-mdpi', 'background.9.png'),
  width: 320,
  height: 480,
  dpi: constants.dpi.mdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-ldpi'] = {
  ...
  ninePath: path.join(':assets:', 'Android', 'Resources', 'drawable-ldpi', 'background.9.png'),
  nineLocalePath: path.join(':assets:', 'Android', 'Resources', 'drawable-:locale:-ldpi', 'background.9.png'),
  width: 240,
  height: 320,
  dpi: constants.dpi.ldpi,
  platforms: ['android'],
